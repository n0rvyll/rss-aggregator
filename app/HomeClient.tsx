  ...
  const toggleRow = (
    ...
    <div className="flex items-center justify-between gap-3 py-1">
      ...
      <button
        ...
        className={[
          "relative inline-flex h-5 w-9 items-center rounded-full transition-colors border shadow-inner",
          checked
      ...
      >
        <span
          className={[
            ...
            // pöcök színei és kontrasztja
            "bg-white dark:bg-neutral-200 shadow ring-1 ring-black/5",
